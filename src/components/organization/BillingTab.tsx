...
const BillingTab: React.FC<BillingTabProps> = ({ organization }) => {
    const [billing, setBilling] = useState<OrganizationBillingData | null>(
        null,
    );
                            ...
                            >
                                ...
                                <Box sx={{ textAlign: 'right' }}>
                                    <Typography
                                        ...
                                        fontWeight={600}
                                    >
                                        {seatBilling.tiers.recruitPremium.seats}{' '}
                                        ×{' '}
                                        {formatCurrency(
                                            seatBilling.tiers.recruitPremium
                                                .pricePerSeat,
                                        )}
                                    </Typography>
                                    <Typography
                        ...
                        {seatBilling.tiers.recruitStandard.seats > 0 && (
                            ...
                            >
                                ...
                                <Box sx={{ textAlign: 'right' }}>
                                    ...
                                    >
                                        {
                                            seatBilling.tiers.recruitStandard
                                                .seats
                                        }{' '}
                                        ×{' '}
                                        {formatCurrency(
                            ...
                            >
                                ...
                                <Box sx={{ textAlign: 'right' }}>
                                    <Typography
                                        ...
                                        fontWeight={600}
                                    >
                                        {seatBilling.tiers.trackerPremium.seats}{' '}
                                        ×{' '}
                                        {formatCurrency(
                                            seatBilling.tiers.trackerPremium
                                                .pricePerSeat,
                                        )}
                                    </Typography>
                                    <Typography
                        ...
                        {seatBilling.tiers.trackerStandard.seats > 0 && (
                            ...
                            >
                                ...
                                <Box sx={{ textAlign: 'right' }}>
                                    ...
                                    >
                                        {
                                            seatBilling.tiers.trackerStandard
                                                .seats
                                        }{' '}
                                        ×{' '}
                                        {formatCurrency(
